...
CREATE TABLE IF NOT EXISTS abanote.note_generation_audit (
  ...
  assessment_excerpt_length integer,
  assessment_excerpt_truncated boolean NOT NULL DEFAULT false,
  prompt_hash text,
  ...
  final_validator_issue_codes jsonb NOT NULL DEFAULT '[]'::jsonb,
  final_critical_issue_codes jsonb NOT NULL DEFAULT '[]'::jsonb,
  validator_issue_count integer NOT NULL DEFAULT 0,
  critical_issue_count integer NOT NULL DEFAULT 0,
  warning_count integer NOT NULL DEFAULT 0,
  structured_plan_history jsonb NOT NULL DEFAULT '[]'::jsonb,
  prose_issue_history jsonb NOT NULL DEFAULT '[]'::jsonb,
  ...
  completion_ids jsonb NOT NULL DEFAULT '[]'::jsonb,
  clinical_body_hash text,
  final_note_hash text,
  raw_model_json jsonb,
  final_note_text text,
  accuracy_confidence text,
  accuracy_selection_honored boolean,
  accuracy_assessment_grounded boolean,
  accuracy_altered_count integer,
  accuracy_report jsonb,
  final_status text NOT NULL,
  created_at timestamptz NOT NULL DEFAULT now()
);

ALTER TABLE abanote.note_generation_audit
  ADD COLUMN IF NOT EXISTS assessment_filename text,
  ADD COLUMN IF NOT EXISTS assessment_hash text,
  ADD COLUMN IF NOT EXISTS assessment_excerpt_length integer,
  ADD COLUMN IF NOT EXISTS assessment_excerpt_truncated boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS prompt_hash text,
  ADD COLUMN IF NOT EXISTS final_validator_issue_codes jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS final_critical_issue_codes jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS validator_issue_count integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS critical_issue_count integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS warning_count integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS structured_plan_history jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS prose_issue_history jsonb NOT NULL DEFAULT '[]'::jsonb,
  ...
  ADD COLUMN IF NOT EXISTS completion_ids jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS clinical_body_hash text,
  ADD COLUMN IF NOT EXISTS final_note_hash text,
  ADD COLUMN IF NOT EXISTS raw_model_json jsonb,
  ADD COLUMN IF NOT EXISTS final_note_text text,
  ADD COLUMN IF NOT EXISTS accuracy_confidence text,
  ADD COLUMN IF NOT EXISTS accuracy_selection_honored boolean,
  ADD COLUMN IF NOT EXISTS accuracy_assessment_grounded boolean,
  ADD COLUMN IF NOT EXISTS accuracy_altered_count integer,
