export const translations = {
  en: {
    ...
    result: {
      ...
      savedFinalRedirect: "Returning home so you can start your next note.",
      savedAs: "Saved as",
    ...
    clientDetail: {
      ...
      assessmentSummaryTab: "Assessment Summary",
      noAssessmentSummary: "No assessment summary on file",
      noAssessmentSummaryHint: "Add a summary from the client edit flow or after uploading an assessment PDF.",
      editAssessmentSummary: "Edit assessment summary",
      editTab: "Edit",
      saveTab: "Save changes",
      savingTab: "Saving…",
      cancelTab: "Cancel",
      saveTabFailed: "Save failed. Try again.",
  ...
  es: {
    ...
    result: {
      ...
      savedFinalRedirect: "Volviendo al inicio para que pueda comenzar su próxima nota.",
    ...
    clientDetail: {
      ...
      assessmentSummaryTab: "Resumen de evaluación",
      noAssessmentSummary: "No hay resumen de evaluación archivado",
      noAssessmentSummaryHint: "Agrega un resumen desde la edición del cliente o después de subir un PDF de evaluación.",
      editAssessmentSummary: "Editar resumen de evaluación",
      editTab: "Editar",
      saveTab: "Guardar cambios",
      savingTab: "Guardando…",
      cancelTab: "Cancelar",
      saveTabFailed: "Error al guardar. Inténtalo de nuevo.",
