...
export function SoftIndigo() {
  ...
  return (
    <div style={{ background: T.bg, minHeight: '100vh', fontFamily: 'Inter, system-ui, sans-serif', color: T.text, display: 'flex', flexDirection: 'column', gap: 32, padding: 28 }}>
      ...
      {/* ── SECTION LABEL ── */}
      <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: T.muted }}>Direction 3 — Soft Indigo</div>
      ...
      <section>
        ...
        <div style={{ display: 'flex', gap: 0, border: `1px solid ${T.border}`, borderRadius: 12, overflow: 'hidden', width: 'fit-content', boxShadow: '0 2px 16px rgba(26,26,46,0.08)' }}>
          {/* Sidebar */}
          <div style={{ width: 200, background: T.surface, padding: '20px 12px', display: 'flex', flexDirection: 'column', gap: 4, borderRight: `1px solid ${T.border}` }}>
            ...
            <div style={{ marginTop: 'auto', paddingTop: 20, display: 'flex', alignItems: 'center', gap: 9 }}>
              <div style={{ width: 30, height: 30, borderRadius: '50%', background: `${T.accent}15`, border: `1.5px solid ${T.accent}50`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, color: T.accent, fontWeight: 700 }}>JD</div>
      ...
      <section>
        ...
        <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 12, padding: 22, width: 340, boxShadow: '0 2px 12px rgba(26,26,46,0.08)' }}>
      ...
      <section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: 340 }}>
          ...
          <div style={{ fontSize: 11, color: T.muted }}>Accent: <span style={{ color: T.accent, fontWeight: 600 }}>#5B5FEF</span> · Background: <span style={{ fontWeight: 600 }}>#F3F4F8</span></div>
        </div>
      </section>
    </div>
  );
