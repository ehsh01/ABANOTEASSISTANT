...
export function DeepSlate() {
  ...
  return (
    <div style={{ background: T.bg, minHeight: '100vh', fontFamily: 'Inter, system-ui, sans-serif', color: T.text, display: 'flex', flexDirection: 'column', gap: 32, padding: 28 }}>
      ...
      {/* ── SECTION LABEL ── */}
      <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', color: T.muted }}>Direction 1 — Deep Slate</div>
      ...
      <section>
        ...
        <div style={{ display: 'flex', gap: 0, border: `1px solid ${T.border}`, borderRadius: 12, overflow: 'hidden', width: 'fit-content', boxShadow: '0 8px 32px rgba(0,0,0,0.4)' }}>
          {/* Sidebar */}
          <div style={{ width: 200, background: T.surface, padding: '20px 12px', display: 'flex', flexDirection: 'column', gap: 4, borderRight: `1px solid ${T.border}` }}>
            ...
            <div style={{ marginTop: 'auto', paddingTop: 20, display: 'flex', alignItems: 'center', gap: 9 }}>
              <div style={{ width: 30, height: 30, borderRadius: '50%', background: `${T.accent}30`, border: `1.5px solid ${T.accent}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, color: T.accent }}>JD</div>
          ...
          <div style={{ width: 260, background: T.bg, padding: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <div style={{ marginTop: 8, height: 6, borderRadius: 3, background: T.surface, width: '80%' }} />
            <div style={{ height: 6, borderRadius: 3, background: T.surface, width: '60%' }} />
            <div style={{ height: 6, borderRadius: 3, background: T.surface, width: '70%' }} />
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 12, padding: 22, width: 340, boxShadow: '0 4px 20px rgba(0,0,0,0.3)' }}>
          ...
          <button style={{ width: '100%', background: T.accent, color: '#0F1117', border: 'none', borderRadius: 8, padding: '10px 0', fontWeight: 700, fontSize: 13, cursor: 'pointer', letterSpacing: '-0.01em' }}>
            Start New Session
          </button>
        </div>
      </section>
        ...
        <div style={{ background: T.surface, border: `1px solid ${T.border}`, borderRadius: 12, padding: 22, width: 340, boxShadow: '0 4px 20px rgba(0,0,0,0.3)' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 14 }}>
            <button
              ...
              style={{ background: T.accent, color: '#0F1117', border: 'none', borderRadius: 8, padding: '9px 22px', fontWeight: 700, fontSize: 13, cursor: 'pointer' }}>
              Next →
            </button>
          </div>
        </div>
      ...
      <section>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: 340 }}>
          <div style={{ display: 'flex', gap: 10 }}>
            <button style={{ background: T.accent, color: '#0F1117', border: 'none', borderRadius: 8, padding: '9px 20px', fontWeight: 700, fontSize: 13, cursor: 'pointer' }}>Primary</button>
            ...
            <button style={{ background: 'transparent', color: T.accent, border: `1px solid ${T.accent}40`, borderRadius: 8, padding: '9px 20px', fontWeight: 600, fontSize: 13, cursor: 'pointer' }}>Ghost</button>
          </div>
          <div>
          ...
          <div style={{ fontSize: 11, color: T.muted }}>Accent: <span style={{ color: T.accent, fontWeight: 600 }}>#00C9A7</span> · Background: <span style={{ fontWeight: 600 }}>#0F1117</span></div>
        </div>
      </section>
    </div>
  );
