            ...
            <div key={c.name} style={{
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: `1px solid ${BORDER}`, paddingTop: 14, gap: 8 }}>
                ...
                <div style={{ display: "flex", gap: 6 }}>
                  <button style={{ fontSize: 11, fontWeight: 700, padding: "5px 11px", borderRadius: 8, border: `1px solid ${BORDER}`, background: BG, color: MUTED, cursor: "pointer" }}>View</button>
                  <button style={{ fontSize: 11, fontWeight: 700, padding: "5px 11px", borderRadius: 8, border: `1px solid ${ROSE}`, background: BG, color: ROSE, cursor: "pointer" }}>Add Note</button>
                </div>
              </div>
            </div>
          ))}
