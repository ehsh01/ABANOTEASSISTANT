...
- **SIB attention + safety chain example:** … implemented Response blocking. Following this intervention, … blocked further contact … The RBT implemented Differential Reinforcement of Alternative Behavior (DRA). Following this intervention, attention was withheld during self-injury and brief praise was delivered when hands remained down …
