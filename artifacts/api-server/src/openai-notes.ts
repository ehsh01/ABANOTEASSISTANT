...
- The server may assign \`replacementProgramForHour[h]\` to align with **common pairings** between that hour's \`maladaptiveBehaviorForHour[h]\` and available replacement programs from the client's list; use the assigned string **verbatim** regardless of pairing.
